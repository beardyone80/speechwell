...
from .views import TherapistListView, TherapistByLocationListView, TherapistRegistrationView, DeleteTherapistView, TherapistUpdateView
...
urlpatterns = [
    ...
    path('delete/<str:username>/', DeleteTherapistView.as_view(), name='confirm_delete_therapist'),
]
